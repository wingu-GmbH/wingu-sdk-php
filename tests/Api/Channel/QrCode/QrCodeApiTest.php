...
use Wingu\Engine\SDK\Model\Response\Channel\QrCode\PublicQrCode;
...
final class QrCodeApiTest extends ChannelApiTestCase
{
    public function testQrCodeReturnsPublicQrCode() : void
    {
        ...
        $expected = new PublicQrCode(
            ...
            'QR 1',
            'https://wingu-sdk-test.de/qrcode/ad68a05f-2f99-43e8-bdb9-5314dd61988b'
        );
    ...
    public function testMyQrCodeReturnsPrivateQrCode() : void
    {
        ...
        $expected = new PrivateQrCode(
            ...
            true,
            new PrivateContent(
                '12d1da34-0000-4000-a000-000000000009',
                [
                    new Pack(
                        '5a69367e-0fc2-4c68-921a-ea5bf7c0fef9',
                        new Deck(
                            'ea45b0c8-0000-4000-a000-000000000009',
                            'Deck 9 title',
                            'Deck description 9',
                            [
                                new Card(
                                    '79522251-26ae-4bf1-9010-a6d1bb235c22',
                                    new Position(0),
                                    new BrandBar(
                                        'eb011d8b-cb96-4afd-8e9b-874a573fe873',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        new BrandBarBackground('4df95d'),
                                        new BrandBarText('wingu brand 9', 'left', '04b1f0'),
                                        new BrandBarImage(
                                            new Image(
                                ...
                                new Card(
                                    '4920e960-7500-4b6d-a6c7-f8ddbf935514',
                                    new Position(1),
                                    new CMS(
                                        'cb1c16c7-65bf-428c-9bf3-c13e5068141a',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                ...
                                new Card(
                                    '35ac13e1-e726-4103-bab4-1227c49f402d',
                                    new Position(2),
                                    new CMS(
                                        '741998bc-138f-4937-9401-7b3e5303e9e4',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                ...
                                new Card(
                                    'd35bed2b-e1d2-4cd1-b57b-5c663f5313cd',
                                    new Position(3),
                                    new Video(
                                        '334c9cad-c3da-477f-b355-fb0550ebc542',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        'youtube',
                                        'zfQdPcO--DA',
                                        'Video description'
                                ...
                                new Card(
                                    '6da7e19b-bb36-4b4e-b5a2-a4605a162cca',
                                    new Position(4),
                                    new ImageGallery(
                                        'f6ed2786-e5a8-4b3b-b530-9b1dd49e557e',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        [
                                            new OuterImage(
                                                '14227b43-b6a7-4b82-b84d-26dfc7d3d2ec',
                                                0,
                                ...
                                new Card(
                                    'ca108698-e6e8-4736-8833-3f8690a29666',
                                    new Position(5),
                                    new SurveyMonkey(
                                        'c9ee91c1-9bbd-45d3-81c9-28b7af0130a5',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        'Take the IQ survey',
                                ...
                                new Card(
                                    '3233c03e-e948-425c-a9ed-d8b982ea0ca4',
                                    new Position(6),
                                    new Contact(
                                        'ee21bc9b-a71f-4fe7-b138-668476515457',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        'Example',
                                        'Mr.',
                                        'Benjamin',
                                        ...
                                        'Some extra info',
                                        new ContactAddress(
                                            '607127fa-a4e3-4c64-be2e-5791e7fae86c',
                                            'DE',
                                            'Oststadt',
                                            '89081',
                                            'Kurfuerstendamm',
                                        ...
                                        new ContactExternalLinks(
                                            '3ef7ac63-3f4a-4511-b240-7044e48694a6',
                                ...
                                new Card(
                                    '1bb8211b-e626-41cf-8911-533105cf5033',
                                    new Position(7),
                                    new Coupon(
                                        'ec6fa888-9d2d-48c0-849f-e8155e52dc5f',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        '-20 %',
                                ...
                                new Card(
                                    '5ed2f552-e279-4c55-9549-e7ebd5ffd088',
                                    new Position(8),
                                    new PrivateForm(
                                        'fb01825e-00b6-4df2-9c05-67861e294c41',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                ...
                                new Card(
                                    '41777e69-895e-4320-afbd-c79a3002f183',
                                    new Position(9),
                                    new Location(
                                        '4e4f1d7d-725f-48fe-a255-1f503f0344b4',
                                        new \DateTime('2018-05-18T08:22:41+0000'),
                                        new Coordinates(9.825813, 53.533606),
                                        157
                                    )
                                ),
                                new Card(
                                    ...
                                    new AudioPlaylist(
                                        ...
                                        [
                                            new Media(
                                                '76bfd654-8f9d-42cc-a923-b83f185118bd',
                                                0,
                                            ...
                                            new Media(
                                                '8e42750c-7545-4521-91bb-f8f342bc2673',
                                                1,
                                                'http://www.example.com/audioplaylist/audio_media.mp3',
                                ...
                                new Card(
                                    ...
                                    new Files(
                                        ...
                                        [
                                            new File(
                                                'dedf2cfb-5971-4148-b93f-c656ee391a0a',
                                                0,
    ...
    public function testMyQrCodesReturnsResult() : void
    {
        ...
        $expected = [
            $this->getExpectedMinimalPrivateListQrCode(),
            $this->getExpectedFullPrivateListQrCode(),
        ];
    ...
    private function getExpectedFullPrivateListQrCode() : PrivateQrCode
    {
        return new PrivateQrCode(
            ...
            true,
            $this->getExpectedFunctioningHours(),
            'https://wingu-sdk-test.de/qrcode/29ca5fb4-72c4-4a73-833e-8e597739005e'
        );
    }
}
