...
class ComponentApiTest extends ApiTest
{
    ...
    public function testMyComponentsReturnsResult() : void
    {
        ...
        $expected = [
            ...
            $this->getExpectedAudioPlaylist(),
            $this->getExpectedBrandBar(),
            $this->getExpectedCms(),
            $this->getExpectedContact(),
            $this->getExpectedCoupon(),
            $this->getExpectedFiles(),
    ...
    private function getExpectedAction() : Component
    {
        return new Action(
    ...
    private function getExpectedAudioPlaylist() : Component
    {
    ...
    private function getExpectedBrandBar() : Component
    {
        return new BrandBar(
    ...
    private function getExpectedCms() : Component
    {
        return new CMS(
    ...
    private function getExpectedContact() : Component
    {
        return new Contact(
    ...
    private function getExpectedCoupon() : Component
    {
        return new Coupon(
    ...
    private function getExpectedFiles() : Component
    {
        return new Files(
    ...
    private function getExpectedForm() : Component
    {
    ...
    private function getExpectedImageGallery() : Component
    {
    ...
    private function getExpectedLocation() : Component
    {
        return new Location(
    ...
    private function getExpectedRating() : Component
    {
        return new Rating(
    ...
    private function getExpectedSeparator() : Component
    {
    ...
    private function getExpectedSurveyMonkey() : Component
    {
    ...
    private function getExpectedVideo() : Component
    {
        return new Video(
    ...
    private function getExpectedWebhook() : Component
    {
