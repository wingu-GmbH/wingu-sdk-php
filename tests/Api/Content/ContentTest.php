...
final class ContentTest extends ApiTest
{
    ...
    public function testMyContentsReturnsResult() : void
    {
        ...
        $expected = [
            $this->getExpectedPrivateContent(),
        ];
                        ...
                        [
                            new Card(
                                ...
                                new BrandBar(
                                    ...
                                    new BrandBarImage(
                                        new Image(new ImageMetadata('jpg', 30, 30), 'sample', 'cloudinary'),
                                        'left'
                                    )
                                )
                            ),
                                ...
                                new ImageGallery(
                                    ...
                                    [
                                        new OuterImage(
                                            ...
                                            0,
                                            new Image(new ImageMetadata('jpg', 864, 576), 'sample', 'cloudinary'),
                                            'caption'
                                        ),
                                    ]
                                )
    ...
    private function getExpectedPostedPack() : ResponsePack
    {
        return new ResponsePack(
            ...
            new Locale('angielski', 'en'),
            new \DateTimeImmutable('2018-06-21T08:18:00+0000')
        );
    }
}
